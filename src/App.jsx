...
const P = {
  ...
  "howard-lutnick": {
    ...
    sum: "Documents reveal deeper ties than publicly acknowledged. Admitted under oath to visiting Epstein's island in 2012 — 7 years after claiming he cut contact. Business deals, construction correspondence, and political fundraiser invitations continued through 2015. Facing bipartisan calls for resignation from both Massie (R) and Khanna (D).",
    resp: "Senate testimony Feb 10, 2026: 'I barely had anything to do with that person. I did not have any relationship with him.' Admitted island lunch visit in 2012 with family. 'I have nothing to hide.'",
    ...
    tl: [
      ...
      { date: "Feb 10, 2026", year: 2026, title: "Admits Island Visit Under Oath", desc: "Told Senate Appropriations: 'We had lunch on the island, that is true, for an hour.' Previously claimed contact ended 2005. Also met Epstein 2011 for drinks and 2012 for business deal. Sen. Van Hollen: 'You misled the country and Congress.'", source: "Senate hearing, CNBC, Al Jazeera", url: "https://www.cnbc.com/2026/02/10/lutnick-epstein-island-vacation-congress.html", type: "government", confidence: "primary" },
      { date: "Feb 11, 2026", year: 2026, title: "Bipartisan Resignation Calls", desc: "Massie (R): 'He should just resign. He was in business with Jeffrey Epstein years after Epstein was convicted.' Khanna (D): 'We've got a commerce secretary who is all over the files.' Bondi refused to say if DOJ has investigated his ties.", source: "CNN, CNBC, House Judiciary hearing", url: "https://www.cnbc.com/2026/02/08/epstein-files-trump-lutnick-massie.html", type: "consequence", confidence: "primary" },
    ]
  },
  "bill-gates": {
  ...
  "kathryn-ruemmler": {
    name: "Kathryn Ruemmler", cat: "Legal / Government", role: "Former General Counsel, Goldman Sachs (resigning June 2026)", prev: "Obama White House Counsel", init: "KR",
    sum: "Former Obama White House Counsel. One of 3 people Epstein called after his July 2019 arrest. Files revealed Epstein gave her Hermes bags, Fendi purses, spa visits, Bergdorf Goodman gift cards. She called him 'Uncle Jeffrey.' He referred her legal clients including Bank Edmond de Rothschild. Arranged Woody Allen White House tour through Epstein. Feb 12: Announced resignation from Goldman Sachs effective June 30, 2026.",
    resp: "Goldman Sachs CEO Solomon: 'Kathy has been an extraordinary general counsel.' Ruemmler says she never represented Epstein. Goldman defended her for months before resignation.",
    respDate: "Feb 2026",
    tax: [
    ...
    tl: [
      ...
      { date: "Jul 6, 2019", year: 2019, title: "Epstein Called After Arrest", desc: "Ruemmler was one of 3 people Epstein called after being arrested on child sex trafficking charges at NJ airport. Subject line 'From wapo' — she helped draft language defending his 2008 plea deal as not a 'sweetheart deal.'", source: "Wall Street Journal, CNBC — Feb 12, 2026", url: "https://www.cnbc.com/2026/02/12/epstein-files-goldman-sachs-kathy-ruemmler.html", type: "document", confidence: "primary" },
      { date: "Feb 12, 2026", year: 2026, title: "Announced Resignation from Goldman Sachs", desc: "Announced resignation as Chief Legal Officer effective June 30, 2026. Came after WSJ reported she was one of 3 people Epstein called post-arrest. Files revealed luxury gifts (Hermes bags, Fendi purses, spa visits, Bergdorf Goodman cards), she called him 'Uncle Jeffrey', and he referred her Bank Edmond de Rothschild as a client. Goldman CEO Solomon called her 'extraordinary.'", source: "CNBC, Wall Street Journal — Feb 12, 2026", url: "https://www.cnbc.com/2026/02/12/epstein-files-goldman-sachs-kathy-ruemmler.html", type: "consequence", confidence: "primary" },
    ]
  },
  "josh-harris": {
  ...
  "casey-wasserman": {
    ...
    sum: "Corresponded with Maxwell — told her 'What do I have to do to see you in a tight leather outfit?' Flew on Epstein's plane to Africa via Clinton Foundation in 2002. After files dropped, Chappell Roan and Abby Wambach left his agency. Feb 14: Announced selling his entire agency, telling 4,000 staff 'I've become a distraction.' Keeping LA28 Olympics role despite LA leaders calling for resignation.",
    resp: "'I never had a personal or business relationship with Epstein... It was years before their criminal conduct came to light, and consisted of one humanitarian trip to Africa and a handful of emails that I deeply regret sending.'",
    respDate: "Feb 2026",
    tax: [],
    conn: ["donald-trump"],
    tl: [
      ...
      { date: "Feb 9, 2026", year: 2026, title: "Chappell Roan Leaves Agency", desc: "Grammy-winning pop star Chappell Roan announced leaving Wasserman, citing need for representation aligned with her 'moral values.' Soccer legend Abby Wambach also departed. DJ John Summit threatened exit if Wasserman didn't step down.", source: "Rolling Stone, Deadline, NBC — Feb 9-13, 2026", url: "", type: "consequence", confidence: "primary" },
      { date: "Feb 14, 2026", year: 2026, title: "Announced Selling Entire Agency", desc: "Sent memo to 4,000 staff: 'I believe that I have become a distraction. That is why I have begun the process of selling the company.' Investors pushed him to act. Mike Watts takes day-to-day control. Keeping LA28 Olympics chairmanship — LA28 board backed him Feb 11 but LA leaders called for his resignation. IOC Vice President said she had 'full trust' in Wasserman.", source: "NBC, CNN, Axios, Deadline, Hollywood Reporter — Feb 14, 2026", url: "https://www.nbcnews.com/news/us-news/casey-wasserman-selling-talent-agency-epstein-rcna259042", type: "consequence", confidence: "primary" },
    ]
  },
  "brett-ratner": {
  ...
  "sultan-bin-sulayem": {
    ...
    tl: [
      ...
      { date: "Feb 13, 2026", year: 2026, title: "Resigned as DP World CEO", desc: "Resigned 'effective immediately' as Chairman and CEO of DP World after Canada's La Caisse pension fund ($5B invested) paused new deals and UK's British International Investment demanded action. Replaced by Essa Kazim (chairman) and Yuvraj Narayan (CEO). Massie: 'Khanna and I first discovered his name Monday. Today he resigns.' Bloomberg called him 'one of the most influential businesspeople to be felled by Epstein.'", source: "Bloomberg, CNBC, The Hill, Al Jazeera — Feb 13, 2026", url: "https://thehill.com/policy/international/5737116-dp-world-sultan-ahmed-bin-sulayem-resignation-epstein-files/", type: "consequence", confidence: "primary" },
    ]
  },

  "lesley-groff": {
    name: "Lesley Groff", cat: "Associate / Employee", role: "Epstein's Executive Assistant (20+ years)", prev: "Long-time personal secretary to Epstein", init: "LG",
    sum: "Epstein's executive assistant for over two decades. Managed logistics, travel, property access, and scheduling. Named by FBI as a co-conspirator in August 2019 — but was never notified of this designation until her name was unredacted in February 2026. Her attorney states she cooperated fully with prosecutors and was told she would not be prosecuted. Received immunity under the 2008 plea deal.",
    resp: "Attorney Michael Bachner: 'Lesley had never seen this document and was unaware of it. Neither Lesley nor her counsel were ever notified that she was considered a co-conspirator. After Lesley voluntarily spoke with prosecutors and answered each and every question asked of her, she was told that she was not being prosecuted.'",
    conn: ["ghislaine-maxwell", "leslie-wexner"],
    tax: [],
    tl: [
      { date: "1990s-2019", year: 1995, title: "Executive Assistant to Epstein", desc: "Served as Epstein's primary executive assistant for over 20 years. Managed travel logistics, property access, and scheduling across Epstein's multiple residences.", source: "Court records, DOJ Files", url: "", type: "contact", confidence: "primary" },
      { date: "2007", year: 2007, title: "Named Co-Conspirator in Plea Deal", desc: "Identified as one of 4 named co-conspirators in the 2008 plea deal negotiated by Alexander Acosta. Received blanket immunity. Never charged despite the deal later being ruled a violation of victims' rights.", source: "2008 NPA, court records", url: "", type: "document", confidence: "primary" },
      { date: "Aug 15, 2019", year: 2019, title: "Listed on FBI Co-Conspirator Document", desc: "FBI Criminal Investigative Division internal document lists Groff as co-conspirator alongside Maxwell, Brunel, Wexner, and others. Groff was never notified of this designation.", source: "FBI internal document, released Feb 2026", url: "", type: "document", confidence: "primary" },
      { date: "Feb 9, 2026", year: 2026, title: "Name Unredacted from FBI Document", desc: "Previously redacted name revealed after congressional pressure from Reps. Massie and Khanna. Groff's attorney says she cooperated fully and was told she would not be prosecuted.", source: "CNN, NBC News, Feb 2026", url: "https://www.cnn.com/2026/02/10/politics/epstein-files-names-unredacted", type: "government", confidence: "primary" },
    ]
  },
...
const GOV_FAILURES = [
  ...
  { date: "Feb 11, 2026", title: "Bondi Refuses to Apologize to Survivors", desc: "AG Bondi testified 5+ hours before House Judiciary. When Rep. Jayapal asked survivors to stand and raise hands if DOJ hadn't met with them — ALL raised hands. Jayapal asked Bondi to turn around and apologize. Bondi refused: 'I'm not going to get in the gutter for her theatrics.' Called hearing a 'circus.'", source: "House Judiciary hearing, multiple outlets", type: "government" },
  { date: "Feb 11, 2026", title: "DOJ Surveilled Congressional Epstein Searches", desc: "Getty photographer captured Bondi's binder with page titled 'Jayapal Pramila Search History' — tracking what the lawmaker searched in DOJ's Epstein database. Jayapal: 'Is this the whole reason they opened the files two days early? So they could surveil members to see what we were gonna ask?' Raskin requesting IG investigation. Lofgren called it 'surveillance of Congress by the Trump administration.'", source: "CNBC, CBS, Mediaite — Getty photo", type: "government" },
  { date: "Feb 11, 2026", title: "5-Hour Hearing Yields Zero Commitments", desc: "Despite 5+ hours of questioning, Bondi provided no number when asked how many co-conspirators indicted, refused to confirm any specific investigations, would not commit to releasing unredacted Trump emails, and attacked nearly every questioner personally. The hearing produced 'few, if any revelations from the attorney general.'", source: "NBC, CNN, PBS", type: "government" },
  { date: "Feb 11, 2026", title: "'Pending Investigations' Contradicts July Memo", desc: "When Rep. Chip Roy asked if anyone else would be prosecuted, Bondi said 'we have pending investigations in our office' — directly contradicting the July 2025 DOJ/FBI memo that said review 'did not uncover evidence that could predicate any investigation.' Deputy AG Blanche separately told ABC the review 'is over.'", source: "CBS, Bloomberg, Washington Times", type: "government" },
  { date: "Feb 11, 2026", title: "Bondi's 'Burn Book' — Oppo Research on Lawmakers", desc: "Bondi came armed with massive binder of opposition research on Democratic members. After each Democrat's questions, she launched personal attacks from the binder — citing crime stats in their districts, past votes, impeachment roles. Rep. Raskin: 'Set the burn book aside and answer our questions.' Moskowitz dared her to read his section.", source: "The Hill, CBS, Fox News", type: "government" },
  { date: "Feb 12, 2026", title: "Bipartisan Condemnation of DOJ Surveillance", desc: "Speaker Johnson (R) — Trump's closest House ally — condemned DOJ tracking of lawmakers' Epstein searches: 'I don't think it's appropriate.' Raskin (D) requested IG investigation. Mace (R) confirmed DOJ is 'TAGGING ALL DOCUMENTS' members open. DOJ claims logging is 'to protect against the release of victim information.' Compared to 2014 CIA spying on Senate staffers during torture investigation.", source: "CNN, The Hill, CNBC — Feb 12, 2026", type: "government" },
  { date: "Feb 15, 2026", title: "Privileged Log Deadline", desc: "DOJ legally required by the Epstein Files Transparency Act to submit to Congress a privileged log explaining why certain redactions were made. This will be the first official accounting of what was withheld and why. Lawmakers and survivors watching closely.", source: "EFTA Section 3, CNN", type: "government" },
  { date: "Feb 14, 2026", title: "Bondi Letter Claims 'All' Files Released", desc: "Bondi and Blanche sent 6-page letter to Senate/House Judiciary leadership claiming DOJ has released 'all' Epstein files under the Transparency Act. Includes list of 300+ 'politically exposed persons' — Trump, Obama, Bill Clinton (1,193 mentions), Gates, Zuckerberg, Prince Harry, Kim Kardashian, Woody Allen, Bruce Springsteen, Kurt Cobain. Claims 'no records withheld or redacted on the basis of embarrassment, reputational harm, or political sensitivity.' Still withholding ~200,000 pages on attorney-client, work-product, and deliberative-process privilege grounds — privileges Congress explicitly rejected in the Act. Redactions claimed for: victim PII, CSAM, active investigations, legal privilege.", source: "Fox News, UPI, Mediaite, San.com — Feb 14-15, 2026", type: "government" },
  { date: "Feb 11, 2026", title: "DOJ Outed Undercover FBI Agent", desc: "Released files included a 2009 sting video showing the face of an undercover FBI employee in a black book operation. Epstein's butler Alfredo Rodriguez was caught selling Epstein's contact book for $50K. DOJ asked CNN to obscure the face after publication — another catastrophic redaction failure that endangered a federal agent.", source: "CNN, Daily Beast, Feb 11, 2026", type: "government" },
  { date: "Feb 13, 2026", title: "Democrats Eye Legal Action Over Surveillance", desc: "Rep. Balint told Axios 'we are within our right to pursue legal action.' Outside advocacy groups 'definitely exploring' legal recourse. Garcia announced 'full investigation.' Minority Leader Jeffries: 'There is no bottom for the Trump administration. It's a disgrace.' Jordan dismissed concerns, comparing to Jack Smith investigation.", source: "Axios, The Hill, Washington Examiner — Feb 13, 2026", type: "government" },
];
...
const CONSEQUENCES = [
  ...
  { name: "Howard Lutnick", role: "Commerce Secretary", action: "Admitted visiting Epstein's island in 2012 for lunch with family — after previously claiming he cut ties in 2005. Both Massie (R) and Khanna (D) called for his resignation. Senate testimony Feb 10: 'I barely had anything to do with that person.' Van Hollen: 'You misled the country and Congress.' White House standing behind him.", date: "Feb 10-11, 2026", profileId: "howard-lutnick", type: "public_pressure" },
  { name: "DOJ Congressional Surveillance Exposed", role: "Department of Justice", action: "Getty photo at Feb 11 hearing revealed Bondi had printout of Rep. Jayapal's Epstein file search history. DOJ apparently tracked what lawmakers searched in the database. Jayapal organizing letter to investigate. Raskin requesting IG probe. Former Rep. Lofgren: 'It's a surveillance of Congress by the Trump administration.'", date: "Feb 11, 2026", type: "government" },
  { name: "Bondi's Credibility Damaged", role: "Attorney General", action: "Feb 11 hearing widely seen as damaging. NBC poll showed 3-to-1 public disapproval of admin's Epstein handling. Rep. Lieu accused her of lying under oath. CNN takeaway: 'Bondi didn't come to answer tough questions. She came to survive the hearing.' Attacked lawmakers from both parties. Called Trump 'greatest president in American history.'", date: "Feb 11, 2026", type: "public_pressure" },
  { name: "Bipartisan Surveillance Backlash", role: "Congress vs DOJ", action: "Feb 12: Speaker Johnson (R) condemned DOJ tracking of lawmakers' Epstein searches — breaking with Trump admin. Raskin (D) requested IG investigation. Mace (R) confirmed DOJ tagging all documents members open. Jayapal (D) organizing formal letter. Massie (R): DOJ used search data as 'oppo research' with 'flash cards with insults.' Even Newsmax host criticized DOJ redactions.", date: "Feb 12, 2026", type: "government" },
  { name: "Legal Action Threatened Over Surveillance", role: "Democrats vs DOJ", action: "Feb 13: Balint told Axios 'we are within our right to pursue legal action.' Outside advocacy groups 'definitely exploring' legal recourse. Garcia (Oversight ranking member) announced 'full investigation.' Jeffries called it 'a disgrace' and violation of co-equal branches. Compared to 2014 CIA spying on Senate torture investigation staffers. Jordan (R) dismissed, comparing to Jack Smith.", date: "Feb 13, 2026", type: "government" },
  { name: "Sultan bin Sulayem Resigned as DP World CEO", role: "Former DP World Chairman/CEO", action: "Feb 13: Resigned 'effective immediately' after international partners paused deals. Canada's La Caisse ($5B invested) halted new capital. UK's British International Investment demanded action, then resumed deals after resignation. Bloomberg: 'One of the most influential businesspeople to be felled by Epstein.' Massie: 'Khanna and I first discovered his name Monday. Today he resigns.'", date: "Feb 13, 2026", type: "resignation", profileId: "sultan-bin-sulayem" },
  { name: "Peter Mandelson Summoned to Congress", role: "Former UK Ambassador to US", action: "Feb 13: House Oversight Democrats Garcia and Subramanyam sent formal letter requesting testimony. Called Mandelson holder of 'critical information' on Epstein's co-conspirators. Deadline to respond: Feb 27. Under UK Met Police criminal investigation for sharing market-sensitive info with Epstein. PM Starmer apologized for appointing him. Lost: ambassadorship, House of Lords seat, Labour membership.", date: "Feb 13, 2026", type: "government" },
  { name: "Goldman Sachs Top Lawyer Kathy Ruemmler Resigning", role: "Goldman Sachs Chief Legal Officer", action: "Feb 12: Announced resignation effective June 30, 2026 after files revealed she was one of 3 people Epstein called after his July 2019 arrest. Emails showed Epstein gave her Hermes bags, Fendi purses, spa visits. She called him 'Uncle Jeffrey.' He referred her legal clients (Bank Edmond de Rothschild). Former Obama White House Counsel.", date: "Feb 12, 2026", type: "resignation" },
  { name: "Casey Wasserman Selling Agency", role: "LA28 Olympics Chair / Agency CEO", action: "Feb 14: Announced selling his entire talent agency (4,000 employees) after Epstein/Maxwell email fallout. Told staff 'I've become a distraction.' Chappell Roan, Abby Wambach left agency. John Summit threatened exit. Investors pushed him. Keeping LA28 Olympics role despite LA leaders calling for resignation. IOC backed him.", date: "Feb 14, 2026", type: "resignation", profileId: "casey-wasserman" },
  { name: "Bondi Claims 'All' Files Released — Lists 300+ Names", role: "DOJ / Attorney General", action: "Feb 14: 6-page letter to Congress claims DOJ released 'all' files. Lists 300+ 'politically exposed persons' including Trump, Obama, Clinton (1,193 mentions), Gates, Zuckerberg, Prince Harry. Claims no records withheld for 'embarrassment or political sensitivity.' Still withholding ~200K pages on privilege grounds Congress rejected in the Act. Critics: Bondi invoking privileges 'on an overwhelmingly bipartisan basis rejected' by Congress.", date: "Feb 14, 2026", type: "government" },
  { name: "Hillary Clinton Calls Files 'Horrifying' at Munich", role: "Former Secretary of State", action: "Feb 14: At Munich Security Conference, called files 'very troubling and really horrific information.' Said 'needs to be totally transparent so people can hold people accountable.' Noted inclusion doesn't mean crime. Both Clintons still set for depositions — Hillary Feb 26, Bill Feb 27.", date: "Feb 14, 2026", type: "government" },
];
...
const CONTRADICTIONS = [
  ...
  { person: "howard-lutnick", claim: "Told NY Post he cut ties with Epstein in 2005 after seeing his 'disgusting' massage room. Told Senate Feb 10, 2026: 'I barely had anything to do with that person.'", claimDate: "Oct 2024 / Feb 2026", evidence: "2011: phone calls and drinks. 2012: admitted visiting Epstein's island for lunch (Senate testimony). Business deal signed with Epstein. 2014: construction correspondence. 2015: invited Epstein to Clinton fundraiser. Epstein's lawyer obtained Lutnick's nanny's resume. Epstein donated $50K to event honoring Lutnick. Both Massie and Khanna called for his resignation.", evidenceSource: "DOJ Files — emails, contracts, NYT, Senate testimony", profileId: "howard-lutnick" },
  ...
  { person: "pam-bondi", claim: "Bondi Feb 11: 'We have pending investigations in our office' regarding Epstein associates.", claimDate: "Feb 11, 2026", evidence: "July 2025: DOJ/FBI joint memo stated review 'did not uncover evidence that could predicate any investigation against uncharged parties.' Deputy AG Blanche told ABC the review 'is over.' Either investigations started after the memo (despite saying no evidence), or Bondi misstated under oath.", evidenceSource: "House Judiciary hearing, July 2025 DOJ memo, ABC", profileId: null },
  { person: "pam-bondi", claim: "Bondi Feb 11: 'I have spent my entire career fighting for victims' and vowed to investigate any credible evidence.", claimDate: "Feb 11, 2026", evidence: "11 Epstein survivors sat behind her in hearing room. ALL raised hands indicating DOJ hadn't met with them. Bondi refused to turn around and apologize. Called the request 'theatrics.' Dismissed Democrats' questions, offered no victim-centered commitments. CNN: 'She came to survive the hearing.'", evidenceSource: "House Judiciary hearing video, The Hill, CNN analysis", profileId: null },
  { person: "pam-bondi", claim: "Bondi Feb 14 letter: DOJ released 'all' Epstein files. 'No records withheld or redacted on the basis of embarrassment, reputational harm, or political sensitivity.'", claimDate: "Feb 14, 2026", evidence: "DOJ is still withholding ~200,000 pages under attorney-client, work-product, and deliberative-process privileges — exemptions Congress explicitly DID NOT include in the Epstein Files Transparency Act. Bloomberg Law: Bondi is 'invoking privileges that Congress has already rejected on an overwhelmingly bipartisan basis.' Withheld pages include internal DOJ deliberations on charging decisions — exactly what Congress and victims want to see.", evidenceSource: "Bondi letter Feb 14, Bloomberg Law, EFTA text, UPI — Feb 15, 2026", profileId: null },
];
...
const UNANSWERED = [
  ...
  { q: "Why did DOJ track Congress's Epstein search history?", detail: "Getty photo at Feb 11 hearing showed Bondi had printout labeled 'Jayapal Pramila Search History' tracking what the lawmaker searched in DOJ's database. Jayapal: 'Is this the whole reason they opened the files two days early? So they could surveil members to see what we were gonna ask?' Raskin requesting IG investigation. Raises separation of powers concerns.", status: "UNDER INVESTIGATION", source: "CNBC, CBS, Jayapal statement, Feb 11, 2026" },
  { q: "Who are Bondi's 'pending investigations' targeting?", detail: "When Rep. Chip Roy asked if anyone else would be prosecuted, Bondi said 'we have pending investigations in our office.' This directly contradicts the July 2025 DOJ/FBI memo saying there was no evidence to charge anyone. Blanche separately said the review 'is over.' Bondi refused to elaborate on targets.", status: "UNANSWERED", source: "House Judiciary hearing, Bloomberg, Feb 11, 2026" },
  { q: "Has DOJ investigated Lutnick, Phelan, and Feinberg's Epstein ties?", detail: "Rep. Balint asked Bondi directly whether DOJ had spoken with Commerce Sec. Lutnick, Navy Sec. Phelan (2 flight manifests), or Deputy Sec. Def. Feinberg (20+ documents) about their Epstein connections. Bondi refused to answer, said Lutnick 'addressed it himself.' Lutnick admitted visiting Epstein's island in 2012 after previously claiming contact ended in 2005.", status: "UNANSWERED", source: "House Judiciary hearing, CBS, PBS, Feb 11, 2026" },
  { q: "What did the limo driver witness?", detail: "Rep. Lieu cited FBI witness statement from a limo driver who overheard Trump on phone with 'Jeffrey' about 'abusing some girl.' Same driver knew a woman who claimed abuse by Epstein who 'later had her head blown off' in what police said could not have been suicide. Lieu stated DOJ never interviewed this witness.", status: "UNINVESTIGATED", source: "House Judiciary hearing, New Republic, Feb 11, 2026" },
  { q: "Why is DOJ still withholding ~200,000 pages on privilege grounds Congress rejected?", detail: "Bondi's Feb 14 letter claims 'all' files released but DOJ is still withholding approximately 200,000 pages under attorney-client, work-product, and deliberative-process privileges. Congress explicitly did NOT include these exemptions in the Epstein Files Transparency Act. Bloomberg Law: Bondi is 'invoking privileges that Congress has already rejected on an overwhelmingly bipartisan basis.' The withheld pages include internal DOJ deliberations about whether to charge or decline to prosecute — exactly what Congress wants to see.", status: "ANSWERED — BUT RAISES NEW QUESTIONS", source: "Bondi letter Feb 14, Bloomberg Law, Fox News, UPI — Feb 15, 2026" },
  { q: "Why is DOJ tracking which Epstein files Congress views?", detail: "DOJ claims search logging is 'to protect against the release of victim information.' But Bondi used Jayapal's search history as hearing prep — not for victim protection. DOJ staffers sat behind lawmakers watching their screens. Jayapal was told to use only DOJ-provided notepads. Speaker Johnson, Raskin, Mace, and Massie all condemned the practice. Compared to CIA spying on Senate torture investigation staffers in 2014.", status: "UNDER INVESTIGATION", source: "CNN, The Hill, CNBC — Feb 12, 2026" },
];

const CONGRESSIONAL = [
  { name: "Ro Khanna (D-CA)", action: "Co-led Transparency Act. Feb 10: Read 6 redacted names on House floor — Nuara, Mikeladze, Leonov, Caputo, bin Sulayem, Wexner. 'If we found 6 in 2 hours, imagine how many they're covering up in 3 million files.' Called for prosecution of 'the Epstein class.' Called for Lutnick resignation.", stance: "pro", party: "D" },
  { name: "Thomas Massie (R-KY)", action: "Co-led Transparency Act. Feb 9: Forced DOJ to unredact Wexner, identified Sultan bin Sulayem. Feb 11: Grilled Bondi — 'This cover-up spans decades, and you are responsible for this portion of it.' Bondi called him 'failed politician' with 'Trump derangement syndrome.' Massie: 'Within 40 minutes of me catching you red-handed!' Trump endorsed his primary opponent in retaliation.", stance: "pro", party: "R" },
  { name: "Jamie Raskin (D-MD)", action: "Ranking member, House Judiciary. Feb 11: Opened hearing welcoming Epstein survivors in white. Called Bondi's DOJ a 'massive Epstein cover-up.' Bondi called him a 'washed-up loser lawyer.' Feb 12: Requested DOJ Inspector General investigate surveillance of lawmakers' Epstein searches. Called it 'outrageous abuse of power.' Also launched probe into removal of Ed Martin from Weaponization Working Group.", stance: "pro", party: "D" },
  { name: "Mike Johnson (R-LA)", action: "Speaker of the House. Feb 12: Condemned DOJ tracking of lawmakers' Epstein searches — rare rebuke of Trump admin: 'I think members should obviously have the right to peruse those at their own speed and discretion. I don't think it's appropriate for anybody to be tracking that. I will echo that to anybody involved with the DOJ.' Initially called allegation 'unsubstantiated' until Jayapal called him directly.", stance: "pro", party: "R" },
  { name: "Hakeem Jeffries (D-NY)", action: "House Minority Leader. Feb 13: Called DOJ surveillance 'a disgrace' and violation of separate and co-equal branches: 'There is no bottom for the Trump administration.' Previously stated DOJ 'continues to hide documents from the American people' and asked 'who are they protecting?'", stance: "pro", party: "D" },
  { name: "Robert Garcia (D-CA)", action: "Ranking member, House Oversight. Feb 13: Announced Democrats will conduct 'full investigation' into DOJ surveillance of Congress. 'The fact that they're tracking what we're actually looking for is disturbing, and quite frankly, it's corrupt.' Said Bondi hearing proved 'we can't trust the DOJ is providing accurate information.'", stance: "pro", party: "D" },
  { name: "Maxwell Frost (D-FL)", action: "Feb 13: 'It's insane. We're there to conduct oversight, and the Department of Justice shouldn't be spying on us. The most concerning thing is that Bondi had it in the packet to use against people on the committee.'", stance: "pro", party: "D" },
  { name: "Suhas Subramanyam (D-VA)", action: "Viewed unredacted files. Detailed DOJ setup: 'They set up four computers in a really tiny room. Each member has a unique login and password. Every time I log in, I see my search history, which leads me to believe they had access.' Confirmed suspicion when Getty photo came out.", stance: "pro", party: "D" },
  { name: "Jim Jordan (R-OH)", action: "Judiciary Chairman. Dismissed DOJ surveillance concerns. Told Axios: 'It's pretty rich to hear the complaints after what the DOJ has done to Republican members of Congress under Jack Smith.' Ceded time to Bondi during hearing. Allowed Bondi to use GOP members' time for rebuttals.", stance: "obstructing", party: "R" },
  { name: "Hank Johnson (D-GA)", action: "Feb 11: After Jayapal's exchange, pushed Bondi: 'We have the Epstein victim survivors here today. If you would be so kind and honorable as to turn around and face them and apologize for outing them.' Bondi refused.", stance: "pro", party: "D" },
  { name: "Lou Correa (D-CA)", action: "Feb 11: 'We have to make sure we tell those predators there is no place for them to hide. If they commit the crime, they're going to fry for it. It starts with showing us the names of the perpetrators in the Epstein files.'", stance: "pro", party: "D" },
  { name: "Pramila Jayapal (D-WA)", action: "Feb 11: Asked survivors to stand — ALL raised hands saying DOJ hadn't met them. Showed poster: DOJ redacted men's names but exposed victims'. BOMBSHELL: Bondi had Jayapal's Epstein database search history in binder. Feb 12: Revealed DOJ staffers sat behind her watching her screen. Called Johnson directly: 'Mike, it's real. That's my search history exactly in the order I searched it.' Organizing letter to investigate. Demands 'completely different process' for congressional review.", stance: "pro", party: "D" },
  { name: "Ted Lieu (D-CA)", action: "Feb 11: Accused Bondi of lying under oath. Played video of Trump and Epstein at party. Bondi: 'There is no evidence Trump committed a crime.' Lieu then produced FBI witness statement — a limo driver who overheard Trump on phone with 'Jeffrey' about 'abusing some girl.' Same driver knew a woman who claimed abuse by Epstein who was later found dead in suspicious circumstances. Called for Bondi's resignation.", stance: "pro", party: "D" },
  { name: "Becca Balint (D-VT)", action: "Vice Ranking Member, Judiciary. Viewed files 2 days: 'Sickening and enraging. A two-tiered system of justice.' Feb 11: Pressed Bondi on Lutnick/Phelan/Feinberg. Bondi invoked antisemitism; Balint stormed out: 'Are you serious? Talking about antisemitism to a woman who lost her grandfather in the Holocaust?' Feb 13: Told Axios 'we are within our right to pursue legal action.' Coordinating letter demanding DOJ policy change. Theorized DOJ surveilled her Lutnick searches to prep antisemitism attack.", stance: "pro", party: "D" },
  { name: "Jerry Nadler (D-NY)", action: "Feb 11: Asked Bondi directly: 'How many of Epstein's co-conspirators have you indicted? How many perpetrators are you even investigating?' Bondi provided no number. Nadler: 'DOJ has failed to bring any of these perpetrators to justice. Instead, it has engaged in a relentless pursuit of Donald Trump's perceived enemies.'", stance: "pro", party: "D" },
  { name: "Dan Goldman (D-NY)", action: "Feb 11: Pressed Bondi to release unredacted Trump-Epstein email. Bondi attacked him: 'You're about as good of a lawyer today as you were when you tried to impeach President Trump in 2016.' Eventually said DOJ would review and release if not privileged.", stance: "pro", party: "D" },
  { name: "Chip Roy (R-TX)", action: "Feb 11: Second Republican (after Massie) to press Bondi on Epstein. Called victim name exposure 'troubling' and 'concerning.' Asked directly if anyone else would be prosecuted. Bondi's response: 'We have pending investigations in our office' — contradicting the July 2025 memo.", stance: "pro", party: "R" },
  { name: "Jared Moskowitz (D-FL)", action: "Feb 9: Confirmed key files retained redactions in 'unredacted' room. Feb 11: After watching Bondi use her binder to attack every Democrat, dared Bondi: 'Flip to the Jared Moskowitz section of the binder. I'm interested to see what staff provided on the oppo on me.' Pulled out poster board and marker: 'I want it from the burn book.'", stance: "pro", party: "D" },
  { name: "James Comer (R-KY)", action: "House Oversight Chair. Overseeing depositions: Maxwell (completed Feb 10 — pleaded Fifth), Wexner (Feb 18), Hillary Clinton (Feb 26), Bill Clinton (Feb 27), Richard Khan (Mar 11), Darren Indyke (Mar 19). Rejected Maxwell's clemency demand.", stance: "pro", party: "R" },
  { name: "Alexandria Ocasio-Cortez (D-NY)", action: "Feb 9: Challenged Deputy AG Blanche directly on Wexner: 'Why did you redact Les Wexner's name here in the first place? Are there other documents where you have redacted his name, which is against Congress' orders?'", stance: "pro", party: "D" },
  { name: "Nancy Mace (R-SC)", action: "Feb 11: Told CNN: 'I personally have lost all faith in our Justice Department.' Said DOJ system for lawmakers was 'insulting.' Feb 12: Confirmed DOJ is 'TAGGING ALL DOCUMENTS Members of Congress search, open and review.' Told Piers Morgan: 'You would be shocked at some of the names — people on both sides of the aisle, famous people, rich people, prime ministers, former presidents, media personalities.'", stance: "pro", party: "R" },
  ...
  { name: "Cynthia Lummis (R-WY)", action: "Feb 10: Publicly acknowledged the gravity of the Epstein revelations. 'Finally gets why Epstein is a big deal.'", stance: "pro", party: "R" },
  { name: "Eric Swalwell (D-CA)", action: "Feb 11: In rare bipartisan moment, detailed death threats against his family. Asked Bondi for help. 'I'm just asking for your help to protect life, because life is at risk with the environment we're in right now.'", stance: "pro", party: "D" },
  { name: "House Oversight Committee", action: "Depositions confirmed: Maxwell (Feb 10 — pleaded Fifth), Wexner (Feb 18), H. Clinton (Feb 26), B. Clinton (Feb 27), Khan (Mar 11), Indyke (Mar 19). Bipartisan investigation ongoing.", stance: "pro", party: "Bipartisan" },
  { name: "Pam Bondi (AG)", action: "Feb 11: 5+ hour combative testimony before House Judiciary. Refused to apologize to survivors sitting behind her. Called Massie 'failed politician,' Raskin 'washed-up loser lawyer,' dismissed all Dem questions as 'theatrics.' Had DOJ 'burn book' with oppo research on lawmakers. Caught with Jayapal's Epstein search history. Said 'pending investigations' exist but gave zero details. When asked how many co-conspirators indicted: no answer. Called Trump 'the greatest president in American history.' Said Maxwell 'will hopefully die in prison.'", stance: "obstructing", party: "R" },
  { name: "Todd Blanche (Deputy AG)", action: "Feb 9: Called Massie's concerns 'grandstanding.' Unredacted 16 names after pressure. Said 'nothing in there that allowed us to prosecute anybody' — contradicted by Bondi's 'pending investigations' statement 2 days later. Told ABC the review 'is over.'", stance: "mixed", party: "R" },
  { name: "Kash Patel (FBI Dir)", action: "Testified 2025 that FBI had no knowledge of other sex traffickers. FBI's own 2019 document labels Wexner as co-conspirator — raising perjury questions. Feb 11: Massie played Patel clip at Bondi hearing. Has not addressed the contradiction.", stance: "neutral", party: "R" },
  { name: "Most of Congress", action: "Transparency Act passed 427-1 in House, unanimously in Senate. Yet the vast majority of members have made no public statements demanding DOJ release the other 3M withheld pages or explain why only 1 of 10 co-conspirators was charged.", stance: "silent", party: "Both" },
];
...
const CORRECTIONS_LOG = [
  ...
  { date: "Feb 11, 2026", entry: "MAJOR UPDATE — Bondi House Judiciary hearing: 5+ hour testimony. Congressional tracker expanded from 17 to 24 entries. Added Jayapal, Lieu, Balint, Nadler, Goldman, Chip Roy, Swalwell. Updated Massie, Raskin, Moskowitz, Mace, Bondi, Blanche entries with Feb 11 hearing details." },
  { date: "Feb 11, 2026", entry: "Bondi stance changed from 'mixed' to 'obstructing' based on hearing conduct: refused to answer questions, attacked lawmakers personally, refused to apologize to survivors, provided no indictment numbers." },
  { date: "Feb 11, 2026", entry: "DOJ surveillance of Congress: Bondi photographed with Jayapal's Epstein database search history. Added to Government Failures, Unanswered Questions. Source: Getty photo, CNBC, CBS." },
  { date: "Feb 11, 2026", entry: "Lesley Groff full profile added. FBI co-conspirator (Aug 2019) who was never notified. Attorney says she cooperated fully. Co-conspirator entry updated with new details." },
  { date: "Feb 11, 2026", entry: "Added Bondi contradictions: 'pending investigations' vs July 2025 memo; 'fighting for victims' vs refusing to face survivors. Noted as contradictions, not confirmed perjury." },
  { date: "Feb 11, 2026", entry: "Lutnick consequence added: admitted island visit 2012, facing bipartisan resignation calls. Previously claimed contact ended 2005. Phelan (2 flights) and Feinberg (20+ docs) also in files." },
  { date: "Feb 11, 2026", entry: "Ted Lieu lying-under-oath accusation noted. Lieu cited limo driver FBI witness statement re: Trump and Epstein. Bondi denied any evidence exists. Noted as accusation, not adjudicated." },
  { date: "Feb 13, 2026", entry: "Congressional tracker expanded from 24 to 32 entries. Added: Jeffries (Minority Leader), Garcia (Oversight ranking), Frost, Subramanyam, Jordan, Hank Johnson, Lou Correa, Mike Johnson (Speaker)." },
  { date: "Feb 13, 2026", entry: "Updated Balint entry with legal action threat (Axios), Democracy Now interview theorizing DOJ surveilled her Lutnick searches, coordinating policy change letter." },
  { date: "Feb 13, 2026", entry: "Updated Jayapal with Feb 12 details: called Speaker Johnson directly, DOJ staffers sat behind her watching screen, demands 'completely different process.'" },
  { date: "Feb 13, 2026", entry: "DOJ outed undercover FBI agent added to government failures. 2009 sting video showed face of undercover employee in black book operation." },
  { date: "Feb 13, 2026", entry: "Legal action consequence added. Balint, advocacy groups exploring lawsuits. Garcia 'full investigation.' Jeffries escalated to 'disgrace.' Jordan dismissed." },
  { date: "Feb 13, 2026", entry: "Added Feb 15 privileged log deadline to government failures and unanswered questions. EFTA requires DOJ to explain every redaction to Congress." },
  { date: "Feb 13, 2026", entry: "Added unanswered question: Why is DOJ tracking Congress's Epstein searches? DOJ claims 'victim protection.' Bondi used data as hearing prep." },
  { date: "Feb 13, 2026", entry: "Updated Mace: confirmed DOJ 'TAGGING ALL DOCUMENTS.' Told Piers Morgan 'You would be shocked' — 'prime ministers, former presidents, media personalities.'" },
  { date: "Feb 13, 2026", entry: "Updated Raskin: Feb 12 formally requested DOJ IG investigation into surveillance. Called it 'outrageous abuse of power.' Also launched probe into Ed Martin removal." },
  { date: "Feb 13, 2026", entry: "BREAKING — Sultan bin Sulayem resigned as DP World CEO/Chairman. Added resignation timeline event, updated summary, added consequence entry. La Caisse paused $5B, BII demanded action." },
  ...
  { date: "Feb 15, 2026", entry: "Hillary Clinton: Called files 'horrifying' at Munich Security Conference Feb 14. Both Clintons still set for depositions Feb 26-27. Added consequence entry." },
  { date: "Feb 15, 2026", entry: "Privileged log unanswered question updated: DOJ met Feb 15 deadline but answer raises new questions — why withhold 200K pages on privileges Congress explicitly rejected?" },
];
