...
const UNANSWERED = [
  ...
  { q: "What will the Feb 15 privileged log reveal?", detail: "The Epstein Files Transparency Act requires DOJ to submit a privileged log to Congress by Feb 15 explaining every redaction and withheld document. This is the first official accounting of what was hidden and why. Will DOJ comply or miss another deadline? Previous compliance has been partial at best.", status: "PENDING — DUE FEB 15", source: "EFTA Section 3, CNN, Feb 12, 2026" },
      ...
      <div style={{ minHeight: "100vh", background: "#0a0a0c", color: "#e2e2e8", fontFamily: serif }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 24px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 40, fontFamily: mono, flexWrap: "wrap" }}>
            ...
            <span style={{ fontSize: 11, color: gold, fontWeight: 700 }}>Feb 13, 2026 · 8:00 PM ET</span>
