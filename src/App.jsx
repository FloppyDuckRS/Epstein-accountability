...
const CONGRESSIONAL = [
  ...
  { name: "Jamie Raskin (D-MD)", action: "Ranking member, House Judiciary. Feb 11: Opened hearing welcoming Epstein survivors in white. Called Bondi's DOJ a 'massive Epstein cover-up.' Bondi called him a 'washed-up loser lawyer — not even a lawyer.' Raskin asking DOJ Inspector General to investigate surveillance of lawmakers' Epstein search histories.", stance: "pro", party: "D" },
  { name: "Pramila Jayapal (D-WA)", action: "Feb 11: Asked Epstein survivors to stand — all raised hands saying DOJ hadn't met with them. Demanded Bondi apologize; Bondi refused, called it 'theatrics.' Showed poster: DOJ redacted men's names but exposed victims' names. BOMBSHELL: Getty photographer captured Bondi's binder with page titled 'Jayapal Pramila Search History' — DOJ had tracked what Jayapal searched in the Epstein database. Jayapal: 'Is this the whole reason they opened the files to us two days early? So they could surveil us?' Organizing letter to investigate DOJ surveillance of Congress.", stance: "pro", party: "D" },
  ...
  { name: "Becca Balint (D-VT)", action: "Feb 11: Pressed Bondi on Trump officials in Epstein files — Lutnick, Navy Sec. Phelan, Deputy Sec. Def. Feinberg. Bondi refused to answer, said Lutnick 'addressed it himself.' Bondi then invoked antisemitism against Balint, who lost grandfather in Holocaust. Balint: 'Are you serious? Talking about antisemitism to a woman who lost her grandfather in the Holocaust?'", stance: "pro", party: "D" },
  ...
  { name: "Nancy Mace (R-SC)", action: "Feb 11: Told CNN after hearing: 'I personally have lost all faith in our Justice Department. It's a system of injustice.' Said DOJ system for lawmakers was 'insulting.' Thousands of victims 'could not have existed without accomplices.' Plans to review unredacted files again.", stance: "pro", party: "R" },
      ...
      <div style={{ minHeight: "100vh", background: "#0a0a0c", color: "#e2e2e8", fontFamily: serif }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 24px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 40, fontFamily: mono, flexWrap: "wrap" }}>
            ...
            <span style={{ fontSize: 11, color: gold, fontWeight: 700 }}>Feb 11, 2026 · 9:30 PM ET</span>
